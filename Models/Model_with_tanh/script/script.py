...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load("../results/b4_iv_e3/500ep.pth"))
    ...
    #torch.save(model.state_dict(), 'data/Results/all_10.pth')

    weight_matrix = list(model.parameters())[:7]
    ...
    np.save('../results/b4_iv_e3/loss_500ep.npy', loss_function)

    torch.save(model.state_dict(), '../results/b4_iv_e3/500ep.pth')
