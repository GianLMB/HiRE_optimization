# Deprecated: old version, replaced by create_datasetCSV.py
# Extract features from TOP and PDB files to create the dataset, stored as adictionary
...
def extract_PDB(filename):
    ...
    coords = np.array(coords, dtype='float64').transpose()
    return coords
...
def load_pars():
    ...
    pickle.dump(fixed_pars, open('/home/flechenault/Documents/Gianluca/RNAEnergy/data/RNAseq/fixed_pars.p', 'wb'))
    pickle.dump(pars, open('/home/flechenault/Documents/Gianluca/RNAEnergy/data/RNAseq/pars.p', 'wb'))
