# Functions to compute energy for local interactions, appearing in the LocalEnergyOpt class from 
# data_classes.py file. All computations are already checked with HiRE model.
# Parameters given as inputs are divided in bond, angles, torsions related and global parameters.
