...
module restart_module
  ...
  subroutine save_restart(current_simulation_time,conformation)
    ...
    integer(8), intent(in) :: current_simulation_time
    real(8), dimension(NATOMS) :: x,y,z,vx,vy,vz,xp,yp,zp
  ...
  subroutine read_restart(current_simulation_time, conformation)
    ...
    integer :: i, ierror  
    real(8) :: current_temperature
    integer(8), intent(out) :: current_simulation_time
    real(8), dimension(NATOMS) :: x,y,z,vx,vy,vz,xp,yp,zp
    character(len=100) fname
