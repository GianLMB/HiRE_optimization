...
#define BUILD_MACHINE "Linux 4.15.0-1027-oem x86_64"

/* Date and time for build */
#define BUILD_TIME "Wed Dec 18 15:15:17 CET 2019"

/* User doing build */
#define BUILD_USER "liuba@precision"
...
#define PACKAGE_STRING "xdrfile 1.1b"
