...
if __name__ == '__main__':
    ...
    # seq_dataloader = DataLoader(seq_data,**params)  # ,num_workers=1,pin_memory=True)
...
## TODO: check execution time for epoch on cpu and gpu as function of batch size, and do some analysis on learning rate