# Script to copy the values of parameters from parameters_table.txt file to scaleRNA.dat
# and parametres_RNA.top, where they can be read to perform molecular dynamics simulations
# Functions are written in order to keep the same structure and format of the original files 
# that are modified
