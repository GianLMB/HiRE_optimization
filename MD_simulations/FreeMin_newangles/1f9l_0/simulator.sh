...
setenv use_qbug                            no   # yes or no (stops at first step)
...
setenv Force_Threshold_Minimization      5      # Force threshold for minimization, modified from 1.10 
setenv Time_Step_DampedMD                2      # Time step for the damped MD minimization (fs)

##====Internal Coordinates
#setenv Internal_Coordinates             .false.
#setenv Backbone_Variables               .false.
#setenv Base_Sugar_Variables             .false.
#setenv Valence_Angle_Variables          .false.
...
setenv simulation_time                   10    # total time of production (in ns)
